  ...
  return (
    <main>
      ...
      <section className="section workforce" id="workforce">
        ...
        <div className="workforce-diagram" aria-label="Atlas coordinating three specialized AI workers"><div className="atlas-node"><small>Atlas</small><strong>Mission coordination</strong></div><div className="worker-row"><div><small>Worker 01</small><strong>Operations Worker</strong><p>Process coordination</p></div><div><small>Worker 02</small><strong>Finance Worker</strong><p>Financial operations</p></div><div><small>Worker 03</small><strong>Support Worker</strong><p>Customer operations</p></div></div></div>
      </section>
