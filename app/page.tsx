  ...
  return (
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="ValisMesh home"><img src="/brand/valismesh-wordmark.png" alt="ValisMesh" /></a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual" aria-label="ValisMesh logo"><div className="visual-grid" /><div className="visual-glow" /><img src="/brand/valismesh-logo.png" alt="" /><div className="visual-caption"><span>Specialized workers</span><span>Governed collaboration</span><span>Human oversight</span></div></div>
      </section>
      ...
      <section className="section about" id="about">
        <div className="about-mark"><img src="/brand/valismesh-logo.png" alt="" /></div>
      ...
      <footer><img src="/brand/valismesh-wordmark.png" alt="ValisMesh" /><p>© 2026 ValisMesh LLC. All rights reserved.</p><p>Georgia, United States</p></footer>
    </main>
  );
}
