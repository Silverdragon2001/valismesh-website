  ...
  return (
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="ValisMesh home"><img className="brand-symbol" src="/brand/valismesh-mesh-symbol.png" alt="" /><img className="brand-wordmark" src="/brand/valismesh-mesh-wordmark-approved.png" alt="ValisMesh" /></a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual" aria-label="ValisMesh logo"><div className="visual-grid" /><img src="/brand/valismesh-mesh-symbol.png" alt="" /><div className="visual-caption"><span>Specialized workers</span><span>Governed collaboration</span><span>Human oversight</span></div></div>
      </section>
      ...
      <section className="section workforce" id="workforce">
        ...
        <div className="workforce-roster" aria-label="AI workforce coordinated by Atlas"><div className="workforce-coordinator"><small>Coordinated by Atlas</small><strong>Mission coordination</strong></div><div className="worker-row"><div><small>Worker 01</small><strong>Operations Worker</strong><p>Process coordination</p></div><div><small>Worker 02</small><strong>Finance Worker</strong><p>Financial operations</p></div><div><small>Worker 03</small><strong>Support Worker</strong><p>Customer operations</p></div></div></div>
      </section>
      ...
      <section className="section about" id="about">
        <div className="about-mark"><img src="/brand/valismesh-stacked-lockup.png" alt="" /></div>
      ...
      <footer><img src="/brand/valismesh-mesh-full-lockup-approved.png" alt="ValisMesh — AI workforce. Business execution. Governed." /><p>© 2026 ValisMesh LLC. All rights reserved.</p><p>Georgia, United States</p></footer>
    </main>
  );
}
